...
const About = () => {
  ...
  return (
    <View style={styles.aboutContainer}>
      <Text style={styles.mainHeader}> Kalpesh Valiya </Text>
      <Text style={styles.paraStyle}> I am a developer 😀 </Text>
      ...
      <View style={styles.aboutLayout}>
        ...
        I am a dedicated and experienced developer with a deep love for technology and its limitless possibilities.
